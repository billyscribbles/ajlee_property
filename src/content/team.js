  ...
  members: [
    {
      ...
      bioLong:
        'Leads the overall strategy and direction of the business, working closely with clients to drive strong outcomes across both sales and property management. Known for a hands-on approach, clear communication, and a focus on delivering results that align with each client’s goals.',
    },
    {
      name: 'Ben Li',
      role: 'Sales Manager',
