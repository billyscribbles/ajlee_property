export const whyChoose = {
  ...
  features: [
    { icon: 'User', title: 'Client first', body: 'Your goals, our priority.' },
    {
      icon: 'Award',
      title: 'Proven results',
      body: 'Trusted expertise. Outstanding outcomes.',
    },
    {
      icon: 'MapPin',
      title: 'Local experts',
      body: "Melbourne's South East specialists.",
    },
  ],
}
